...
public class AzureBatchWithSpringBootJar {

    // Get Batch and storage account information from environment
    static String BATCH_ACCOUNT = "batchdemoaccount";
    static String BATCH_ACCESS_KEY = "d3w1m64Hdbkn8ihHofbKTnT0h9E8VjRFX+XkCKt/7+SKGm3Y9jFo8qbO9JwgHbTjOJ7hnrM2vfPG+ABaJBrN2g==";
    static String BATCH_URI = "https://batchdemoaccount.eastus.batch.azure.com";
    static String STORAGE_ACCOUNT_NAME = "batchdemostrgaccnt";
    static String STORAGE_ACCOUNT_KEY = "5glVZLekVdFYhujKGXbxyK1vzPknVw1BJiKAVZ5sPQ7x3yOtM/ANphI1p8CFkBeX+0O7VVfmBLgd+AStdBWIrw==";
    ...
    static boolean CLEANUP_JOB = false;
